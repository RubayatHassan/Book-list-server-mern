...
const signupUser = (user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield session.endSession();
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'User Already Exists with this ');
    }
    if (newUserData) {
...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = jwtHelpers_1.jwtHelpers.createToken({ id, email }, config_1.default.jwt.secret, config_1.default.jwt.expires_in);
    const refreshToken = jwtHelpers_1.jwtHelpers.createToken({ id, email }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
    return {
        accessToken,
        refreshToken,
        user: isUserExist,
...
const refreshToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield user_model_1.User.isRefreshedUserExist(id);
    if (!isUserExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'User does not exist');
    }
    //generate new token
